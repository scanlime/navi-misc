...
{ // sync with arm9 and init wifi
  ...
  while (1) {
    ...
    /* Detect the ARM9's reboot loop (M3/SC-style) */
	...
	*(vuint16*)addr = 0;
      ...
      /*
       * This is also from Moonshell. It's setting the
       * entry point for the arm7 to the beginning of the
       * GBAROM, but I'm not sure who loads it from this
       * magical address later.
       */ 
      *((vuint32*)0x027FFE34) = (u32)0x08000000;
