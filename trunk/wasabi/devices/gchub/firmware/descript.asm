;################################################################################
;
; descript.asm - USB descriptors for the Gamecube Hub project
;
...
StartDevDescr
	...
	retlw	GCHUB_VENDOR_ID & 0xFF	; idVendor
	retlw	GCHUB_VENDOR_ID >> 8
	retlw	GCHUB_PRODUCT_ID & 0xFF	; idProduct
	retlw	GCHUB_PRODUCT_ID >> 8
	retlw	GCHUB_PROTOCOL_VERSION & 0xFF	; bcdDevice
	retlw	GCHUB_PROTOCOL_VERSION >> 8
