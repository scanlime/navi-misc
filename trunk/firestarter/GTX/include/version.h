...
#ifndef BZ_PROTO_HEADER
#define BZ_PROTO_HEADER	"BZFS"
#endif

#ifndef BZ_PROTO_VERSION
#define BZ_PROTO_VERSION	"-001"
#endif
...
#define BZ_BUILD_TYPE		"EXPERIMENTAL"
#endif
...
{
  static std::string serverVersion = std::string(BZ_PROTO_HEADER) + getProtocolVersion();
