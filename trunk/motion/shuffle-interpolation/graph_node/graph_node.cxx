...
void graph_node::add_edge(int to_node_name)
{
    ...
    else
    {
        ...
        e.weight = 1;
        edges.push_back(e);          //************* check
    }
}

void graph_node::visited_again()
{
    times_visited++;
}
...
void graph_node::set(graph_node a) // sets all members to those of a (=);
{
    name = a.name;
    edges = a.edges;
