;################################################################################
;
; descript.asm - USB descriptors for the Raster Wand project
;
...
StartDevDescr
	...
	retlw	RWAND_VENDOR_ID & 0xFF	; idVendor
	retlw	RWAND_VENDOR_ID >> 8
	retlw	RWAND_PRODUCT_ID & 0xFF	; idProduct
	retlw	RWAND_PRODUCT_ID >> 8
	retlw	RWAND_PROTOCOL_VERSION & 0xFF	; bcdDevice
	retlw	RWAND_PROTOCOL_VERSION >> 8
