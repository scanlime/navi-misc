...
void
setup_druid_servers_populate (GtkWidget *treeview)
{
	GtkListStore *store;
	GtkTreeIter iter;
	ircnet *net;
...
void
setup_druid_nicknames_prepare (GnomeDruidPage *p, GtkWidget *w, gpointer d)
{
	GtkWidget *nick, *real;
...
void
setup_druid_finish_prepare (GnomeDruidPage *p, GtkWidget *w, gpointer d)
{
	gnome_druid_set_show_finish (gui.setup_druid, TRUE);
}

void
setup_druid_finish (GnomeDruidPage *p, GtkWidget *w, gpointer d)
{
	GtkWidget *druid_window;
	GtkWidget *nick, *real;
...
void
setup_druid_nickname_changed (GtkEditable *entry, gpointer d)
{
	GtkWidget *nick, *real;
...
void
setup_druid_realname_changed (GtkEditable *entry, gpointer d)
{
	GtkWidget *nick, *real;
