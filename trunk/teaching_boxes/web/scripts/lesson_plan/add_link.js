...
{
	// Members
	this.div = top.document.getElementById ('add_link')
	this.select = top.document.getElementById ('linkSelect')
	this.addButton = top.document.getElementById ('linkAdd')
	this.cancelButton = top.document.getElementById ('linkCancel')
	this.lessons = new Array ()
	this.lessonObjs = new Array ()
	this.div.options = this.options

	// Methods
	this.selectionChanged = linkSelectionChanged
	this.addButtonClicked = linkAddButtonClicked
	this.cancelButtonClicked = linkCancelButtonClicked
	this.dataLoaded = linkDataLoaded
...
function linkSelectionChanged (event)
{
	parentDiv = this.classObj.div
	select = this.classObj.select
	div = top.document.getElementById ('linkDescription')
...
function linkAddButtonClicked (event)
{
