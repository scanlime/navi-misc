...
; Version 2.3.3 Wed Feb 26 22:08:22 2003
...
;	.globl _RP1
;	.globl _IRP
;	.globl _numIntegrationSamples
;	.globl _numResonationHalfcycles
;	.globl _reading7
;	.globl _reading6
;	.globl _reading5
;	.globl _reading4
...
_EECON2	EQU	0x018d
  ...
  cblock  0X001E	; Bank 0
	...
	_reading7
	_reading7_1
	_numIntegrationSamples
	_numResonationHalfcycles
	bitfield0
  endc
...
_Light3	EQU	( (fbitfield06<<3)+3)
_Light2	EQU	( (fbitfield06<<3)+2)
r0x53	EQU	0x020
r0x54	EQU	0x021
r0x55	EQU	0x022
r0x56	EQU	0x023
...
_reading6	EQU	0x055
_reading7	EQU	0x057
_numIntegrationSamples	EQU	0x059
_PORTB	EQU	0x006
_TRISB	EQU	0x086
_ADCON0	EQU	0x01f
_TRISB	EQU	0x086
_ADCON0	EQU	0x01f
_numResonationHalfcycles	EQU	0x05a
_PORTB	EQU	0x006
_TRISB	EQU	0x086
_ADRESH	EQU	0x01e
_ADRESL	EQU	0x09e
...
;  pBlock Stats: dbName = C
;***
;entry:  _halfSerialBitDelay	;Function start
; 2 exit points
;has an exit
