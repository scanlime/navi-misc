;################################################################################
;
; descript.asm - USB descriptors for the USB Laser Projector
;
...
StartDevDescr
	...
	retlw	LASER_VENDOR_ID & 0xFF	; idVendor
	retlw	LASER_VENDOR_ID >> 8
	retlw	LASER_PRODUCT_ID & 0xFF	; idProduct
	retlw	LASER_PRODUCT_ID >> 8
	retlw	LASER_PROTOCOL_VERSION & 0xFF	; bcdDevice
	retlw	LASER_PROTOCOL_VERSION >> 8
