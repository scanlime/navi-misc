...
# Configgy-thingies
pickleFile = "dubbya.pickle"
triggers = ("terror", "iraq", "UN", "bush", "israel", "bomb")
nickname = "dubbya"
port = 6667
...
# DALnet
#server = "kernel.ga.us.dal.net"
#channels = ("#politics",)

# EFnet
server = "irc.flamed.net"
channels = ("#politics",)
...
class Bot(SingleServerIRCBot):
    def __init__(self, as):
        ...
        self.as = as
        self.logfile = open("dubbya.log", "a")
    ...
    def on_pubmsg_protected(self, c, e):
        ...
        for trigger in triggers:
            if re.search(trigger, line) and random.random() > 0.2:
                triggerFlag = True

        # Was this line addressed to us? If so, remove that part.
        addressed = False
        if re.search(nickname, words[0]):
            addressed = True
            words = words[1:]
