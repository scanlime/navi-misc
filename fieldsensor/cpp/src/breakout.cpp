/*
 * breakout.cpp - Simple breakout-like game using the field sensors
 *
...
int main(void) {
  ...
  game.objects.push_back(new PlayfieldSegment(&game,                      /* Top edge:  */
					      Vector3(0.0, 1.0, 0.0),     /*   left     */
					      Vector3(1.0, 1.0, 0.0),     /*   right    */
					      Vector4(1.0, 1.0, 1.0, 1.0) /*   color    */
					      ));
