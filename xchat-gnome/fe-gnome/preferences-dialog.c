...
initialize_pages_list ()
{
	...
	gtk_list_store_set (store, &iter, 0, pix_prefs_dcc, 1, "File Transfers & DCC", 2, 0, -1);
	gtk_list_store_append (store, &iter);
	gtk_list_store_set (store, &iter, 0, pix_prefs_networks, 1, "Networks", 2, 1, -1);
	gtk_list_store_append (store, &iter);
	gtk_list_store_set (store, &iter, 0, pix_prefs_plugins, 1, "Scripts and Plugins", 2, 2, -1);
	/*
	gtk_list_store_append (store, &iter);
