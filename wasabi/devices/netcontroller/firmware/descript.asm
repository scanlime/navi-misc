;################################################################################
;
; descript.asm - USB descriptors for our device
;
...
;
; Wasabi Net-controller modifications done by Micah Dowty <micah@navi.cx>
;
;###############################################################################
;
...
StartDevDescr
	...
	retlw	GENESIS_VENDOR_ID & 0xFF		; idVendor
	retlw	GENESIS_VENDOR_ID >> 8
	retlw	GENESIS_PRODUCT_ID & 0xFF		; idProduct
	retlw	GENESIS_PRODUCT_ID >> 8
	retlw	GENESIS_PROTOCOL_VERSION & 0xFF	; bcdDevice
	retlw	GENESIS_PROTOCOL_VERSION >> 8
