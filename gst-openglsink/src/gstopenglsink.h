...
#define GST_OPENGLSINK_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_OPENGLSINK,GstOpenGLSinkClass))
...
GType gst_openglsink_get_type(void);

gboolean gst_openglsink_factory_init (GstElementFactory *factory);
