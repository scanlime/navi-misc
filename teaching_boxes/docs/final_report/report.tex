...
12th grade. The amount of teaching experience may vary across users, the
subjects and ages that they teach, the amount of experience with both on-paper
and online teaching boxes, familiarity with the DLESE web site, and degree of
...
% FIXME - replace the URL here with a reference to a screenshot so we're not
% relying on Cory keeping up his webserver.
...
tectonics (see Appendix D) and were asked to design a lesson around this task.
Next, they were asked to create a new lesson, one on a subject that they
commonly teach.
...
people were asked to add a field that they ''forgot'' into the lesson, to make a
