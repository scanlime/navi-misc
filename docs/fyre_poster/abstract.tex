...
%% FIXME: add more explaination to the caption
\end{figure}
...
high-dynamic-range image processing techniques can be applied. By using a
non-linear exposure function and gamma correction, even more information
and detail can be extracted from the image. If the image is not being
analyzed from a scientific basis, oversampling provides an effective means
of smoothing out aliasing.
