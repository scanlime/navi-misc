...
\caption{The Logistic Map, rendered with 200 iterations and traditional 1-bit point plotting.}
\end{figure}

\begin{figure}[htb]
\centering
\includegraphics[width=3in]{figures/logistic-histogram-8m.png}
\caption{At the same image resolution, histogram-based rendering shows the extra detail obtained by running 8 million iterations.}
\end{figure}
