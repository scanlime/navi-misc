...
\begin{figure}[htb]
\centering
\includegraphics[width=6in]{figures/logistic-traditional-200.png}
...
\begin{figure}[htb]
\centering
\includegraphics[width=6in]{figures/logistic-histogram-8m.png}
...
actually rendered with 8 columns of histogram buckets for every single column of pixels.
While this extra data is not explicitly preserved in the image, it visually exposes details
too small to see otherwise, such as high-density cycles.
